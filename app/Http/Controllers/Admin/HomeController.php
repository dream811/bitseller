...
class HomeController extends Controller
{
    ...
    public function realtime_info()
    {
        ...
        $level_users = DB::select('SELECT  user_level.name, user_level.level, COUNT(users.id) AS cnt FROM user_level LEFT JOIN users  ON  user_level.level = users.level GROUP BY user_level.level');
