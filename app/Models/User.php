...
class User extends Authenticatable
{
     ...
     */
    protected $fillable = [
        'name', 'nickname', 'email', 'password', 'str_id', 'level', 'type', 'is_use', 'is_del', 'phone', 'bank_id', 'bank_user', 'bank_account', 'money', 'buy_sum', 'deposit_sum', 'withdraw_sum', 'profit_sum', 'referer'
    ];
